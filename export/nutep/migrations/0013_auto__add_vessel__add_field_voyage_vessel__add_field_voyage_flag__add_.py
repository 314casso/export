...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Vessel'
        db.create_table('nutep_vessel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150, db_index=True)),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
        ))
        db.send_create_signal('nutep', ['Vessel'])

        # Adding field 'Voyage.vessel'
        db.add_column('nutep_voyage', 'vessel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutep.Vessel'], null=True),
                      keep_default=False)

        # Adding field 'Voyage.flag'
        db.add_column('nutep_voyage', 'flag',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Voyage.eta'
        db.add_column('nutep_voyage', 'eta',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Vessel'
        db.delete_table('nutep_vessel')

        # Deleting field 'Voyage.vessel'
        db.delete_column('nutep_voyage', 'vessel_id')

        # Deleting field 'Voyage.flag'
        db.delete_column('nutep_voyage', 'flag')

        # Deleting field 'Voyage.eta'
        db.delete_column('nutep_voyage', 'eta')
