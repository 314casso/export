...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Draft.vessel'
        db.delete_column('nutep_draft', 'vessel')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Draft.vessel'
        raise RuntimeError("Cannot reverse this migration. 'Draft.vessel' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Draft.vessel'
        db.add_column('nutep_draft', 'vessel',
