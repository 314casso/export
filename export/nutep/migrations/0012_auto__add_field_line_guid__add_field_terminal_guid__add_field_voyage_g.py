...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Line.guid'
        db.add_column('nutep_line', 'guid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Terminal.guid'
        db.add_column('nutep_terminal', 'guid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Voyage.guid'
        db.add_column('nutep_voyage', 'guid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Line.guid'
        db.delete_column('nutep_line', 'guid')

        # Deleting field 'Terminal.guid'
        db.delete_column('nutep_terminal', 'guid')

        # Deleting field 'Voyage.guid'
        db.delete_column('nutep_voyage', 'guid')
