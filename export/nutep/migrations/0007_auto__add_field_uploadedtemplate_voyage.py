...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadedTemplate.voyage'
        db.add_column('nutep_uploadedtemplate', 'voyage',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadedTemplate.voyage'
        db.delete_column('nutep_uploadedtemplate', 'voyage_id')
    ...
    models = {
        ...
        'nutep.uploadedtemplate': {
            ...
            'voyage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
