...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BaseError'
        db.create_table('nutep_baseerror', (
            ...
            ('field', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=3, db_index=True, blank=True)),
        ))
        db.send_create_signal('nutep', ['BaseError'])


    def backwards(self, orm):
        # Deleting model 'BaseError'
        db.delete_table('nutep_baseerror')
    ...
    models = {
        ...
        'nutep.baseerror': {
            ...
            'field': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
