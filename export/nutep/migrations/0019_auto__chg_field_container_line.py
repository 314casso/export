...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Container.line'
        db.alter_column('nutep_container', 'line_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutep.Line'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Container.line'
        raise RuntimeError("Cannot reverse this migration. 'Container.line' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Container.line'
        db.alter_column('nutep_container', 'line_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutep.Voyage']))
