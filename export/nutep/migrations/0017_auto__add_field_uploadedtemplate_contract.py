...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadedTemplate.contract'
        db.add_column('nutep_uploadedtemplate', 'contract',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutep.Contract'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadedTemplate.contract'
        db.delete_column('nutep_uploadedtemplate', 'contract_id')
