...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Container.gross'
        db.alter_column('nutep_container', 'gross', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # Changing field 'Container.tare'
        db.alter_column('nutep_container', 'tare', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

        # Changing field 'Container.netto'
        db.alter_column('nutep_container', 'netto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Container.gross'
        db.alter_column('nutep_container', 'gross', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Container.tare'
        db.alter_column('nutep_container', 'tare', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Container.netto'
        db.alter_column('nutep_container', 'netto', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'nutep.container': {
            ...
            'gross': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '3', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'netto': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '3', 'blank': 'True'}),
            ...
            'tare': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '3', 'blank': 'True'}),
