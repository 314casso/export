...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UploadedTemplate.voyage'
        db.alter_column('nutep_uploadedtemplate', 'voyage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutep.Voyage'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'UploadedTemplate.voyage'
        db.alter_column('nutep_uploadedtemplate', 'voyage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))
