...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Readiness'
        db.create_table('nutep_readiness', (
            ...
            ('ordered', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('done', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('draft', self.gf('django.db.models.fields.related.ForeignKey')(related_name='readiness', to=orm['nutep.Draft'])),
        ))
        db.send_create_signal('nutep', ['Readiness'])


    def backwards(self, orm):
        # Deleting model 'Readiness'
        db.delete_table('nutep_readiness')
