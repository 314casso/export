...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('nutep_draft', (
            ...
            ('shipper', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('consignee', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('vessel', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('finalDestination', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('POD', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('POL', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('finstatus', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('poruchenie', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('poruchenieNums', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('notify', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('line', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutep.Line'])),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutep.UploadedTemplate'])),
        ))
        db.send_create_signal('nutep', ['Draft'])

        # Adding model 'Container'
        db.create_table('nutep_container', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=12, db_index=True)),
            ('SOC', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=2, db_index=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=3, db_index=True)),
            ('line', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutep.Voyage'])),
            ('seal', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('cargo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('netto', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('gross', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('tare', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('package', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('draft', self.gf('django.db.models.fields.related.ForeignKey')(related_name='containers', to=orm['nutep.Draft'])),
        ))
        db.send_create_signal('nutep', ['Container'])

        # Adding field 'UserProfile.guid'
        db.add_column('nutep_userprofile', 'guid',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('nutep_draft')

        # Deleting model 'Container'
        db.delete_table('nutep_container')

        # Deleting field 'UserProfile.guid'
        db.delete_column('nutep_userprofile', 'guid')
